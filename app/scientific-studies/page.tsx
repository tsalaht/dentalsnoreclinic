...
const studies = [
  {
    ...
    description:
      "دراسات حول نتائج استخدام الليزر في علاج الشخير واضطرابات النوم.",
  },
  {
    slug: "oral-devices-effectiveness",
    title: "فعالية الأجهزة الفموية",
    description:
      "أبحاث حول فعالية الأجهزة الفموية في تحسين جودة النوم وتقليل الشخير.",
  },
  {
    slug: "muscle-exercises-effectiveness",
    title: "فعالية التمارين العضلية",
    description:
      "دراسات علمية حول دور التمارين العضلية في علاج اضطرابات التنفس أثناء النوم.",
  },
  {
    slug: "misc-studies",
    title: "دراسات متفرقة",
    description:
      "مجموعة من الدراسات المتنوعة حول اضطرابات النوم وطرق العلاج المختلفة.",
  },
];
      ...
      <section className="relative bg-gradient-to-l from-blue-50 to-teal-100 py-12 mt-16 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <Badge className="bg-green-100 text-green-800 hover:bg-green-100 animate-fade-in-up mb-4">
              دراسات علمية
            </Badge>
            ...
            >
              تصفح أحدث الأبحاث والدراسات العلمية حول فعالية العلاجات المختلفة
              للشخير واضطرابات النوم.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {studies.map((study) => (
              <Link
                key={study.slug}
                href={`/scientific-studies/${study.slug}`}
                className="group"
              >
