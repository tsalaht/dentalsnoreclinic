        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8">
            {[
              ...
              { day: 14, task: `<strong>نظرة عامة على المهام:</strong> عمل عظيم! لقد وصلت إلى اليوم 14! فكر فيما نجح وما لم ينجح، وما الروتينات التي ستستمر بها.<br /><hr class="my-2" /><strong>المهام:</strong><br />- زِد نشاط الاسترخاء بدون شاشة إلى ساعة. اقرأ أو تأمل لساعة كاملة.<br /><hr class="my-2" />- ضع خطة لجعل غرفة نومك أكثر ملاءمة للنوم. حل مشكلة واحدة أسبوعيًا.<br /><hr class="my-2" />- راجع خطة نظامك الغذائي للتأكد من استدامتها. استمر بعد أي انقطاع.<br /><hr class="my-2" />- توقف عن شرب الكافيين قبل النوم بثلاث ساعات. التزم بهذا لنوم مريح.`, color: "green" },
            ].map(({ day, task, color }) => (
              <Card 
                key={`day-${day}`} 
